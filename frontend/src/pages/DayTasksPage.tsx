    ...
    <div style={ui.page}>
      ...
      <section style={ui.conditionCard}>
        ...
        <MeterRow
          icon="🌿"
          label="残りの行動"
          value={totalCount === 0 ? 0 : Math.round((remainingCount / totalCount) * 100)}
      ...
      <section style={ui.listCard}>
        <div style={ui.sectionHeaderLight}>
          ...
          <button style={ui.smallButton} onClick={() => navigate("/calendar")}>
            戻る
          </button>
        </div>
